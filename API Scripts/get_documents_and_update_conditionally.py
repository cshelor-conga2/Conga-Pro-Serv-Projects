...
def printData(docDict, docType):
    ...
    for i in range(len(docDict)):
        doc = docDict[i]
        print(doc[docType])
       # if doc[docType]['metadata']['refresh_document_inline_variables'][0] == 'Test Python':
...
### Uses the doc Ids and updates each respective doc with the json data defined in json_key and json_value
